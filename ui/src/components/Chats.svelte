<script>
    ...
    import { getChats, newChat, deleteChat, copyChat } from '../api.js';
    import { createEventDispatcher } from 'svelte';

    const dispatch = createEventDispatcher();

    export let onSelect = chat => console.log(`selected chat ${chat?.label}`);
    ...
    <div class="border-b p-6">
        ...
        <button
            ...
            on:click={async () => {
                ...
                dispatch('chat-event', { action: 'create', chat });
        ...
        <ul>
            {#each chats as chat (chat.id)}
                ...
                <li class="outline-0 mb-4 flex hover:bg-gray-100 rounded-lg"
                    ...
                    transition:fly|local={{ delay: 250, duration: 750, easing: quintInOut, x: -500, y: 0 }}
                >
                    <button
                        ...
                        >
                            <button
                                ...
                                on:click={async () => {
                                    ...
                                    dispatch('chat-event', { action: 'delete', chat });
                                }}
                            >
                            ...
                            <button
                                ...
                                on:click={async () => {
                                    dispatch('chat-event', { action: 'new', chat: await copyChat(chat.id) });
                                }}
                            >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-3 h-3">
